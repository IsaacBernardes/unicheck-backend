...
class Environment:
    ...
    def build_environments(self):
        expected_environments = [
            {"key": EnvKeys.DB_HOST, "type": str, "required": True, "default_value": None},
            {"key": EnvKeys.DB_PORT, "type": int, "required": True, "default_value": 5432},
            {"key": EnvKeys.DB_USER, "type": str, "required": True, "default_value": None},
            {"key": EnvKeys.DB_PASS, "type": str, "required": True, "default_value": None},
            {"key": EnvKeys.DB_NAME, "type": str, "required": True, "default_value": None},
